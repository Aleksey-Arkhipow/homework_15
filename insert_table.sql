...
SELECT DISTINCT animals.age_upon_outcome, animals.animal_id, animals.name, animals.date_of_birth,
                          animal_type.id, animal_breed.id, animal_colors.main_color, animal_colors.second_color,
...
left JOIN animal_colors on animal_colors.main_color = animals.color1
left JOIN animal_colors on animal_colors.second_color = animals.color2
